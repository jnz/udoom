...
#define DEFAULT_GOD_MODE_HEALTH 100
#define DEFAULT_IDFA_ARMOR 200
#define DEFAULT_IDFA_ARMOR_CLASS 2
#define DEFAULT_IDKFA_ARMOR 200
#define DEFAULT_IDKFA_ARMOR_CLASS 2
