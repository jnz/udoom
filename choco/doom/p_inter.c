...
#define DEFAULT_MAX_ARMOR 200
#define DEFAULT_GREEN_ARMOR_CLASS 1
#define DEFAULT_MAX_SOULSPHERE 200
#define DEFAULT_SOULSPHERE_HEALTH 100
#define DEFAULT_MEGASPHERE_HEALTH 200
  ...
  mobj_t*	toucher )
{
	...
	break;
      ...
      case SPR_ARM2:
	if (!P_GiveArmor (player, DEH_DEFAULT_BLUE_ARMOR_CLASS))
	    return;
	...
	if (player->armorpoints > DEFAULT_MAX_ARMOR)
	...
	if (player->health > DEFAULT_MAX_SOULSPHERE)
	    player->health = DEFAULT_MAX_SOULSPHERE;
	player->mo->health = player->health;
